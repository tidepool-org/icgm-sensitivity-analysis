...
if __name__ == "__main__":
    ...
    # Import results from batch-icgm-condition-stats.py
    batch_condition_file = "../data/interim/sample-batch-icgm-condition-stats.csv"
    data_location = "../data/raw/"
    export_folder = "../data/interim/sample-snapshot-export/"
    ...
    for file_selection in range(int(len(condition_df))):
        ...
        file_name = condition_df.loc[file_selection, 'filename']
    ...
    settings_summary_filename = \
        'sample-snapshot-processor-settings-summary-table-' + \
        today_timestamp + \
        '.csv'

    summary_results_path = "../data/interim/" + settings_summary_filename

    settings_summaries.to_csv(summary_results_path, index=False)
